...
export default function OurRituals() {
  useEffect(() => {
    ...
    document.title = "Our Rituals | Lunara Naturals – Daily Wellness Practices for Women";
    setMetaTag('description', "Discover gentle daily rituals to weave Lunara supplements into your morning, midday, and evening routine. Small, loving choices that add up to a life in balance.");
    setMetaTag('keywords', 'daily rituals, wellness routine, self-care habits, morning ritual, evening routine, mindful living');
    setMetaTag('og:title', 'Our Rituals – Lunara Naturals', 'og:title');
